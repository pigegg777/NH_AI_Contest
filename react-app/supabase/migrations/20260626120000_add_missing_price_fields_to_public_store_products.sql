-- Extend get_public_store_products to return all selectable price and product
-- fields. The previous version only exposed tax_price, leaving zero_tax_price,
-- exempt_tax_price, price_subsidy, and other fields inaccessible to the public
-- storefront page.
...
as $$
  select
    ...
    row_data ->> 'product_nutirent'                  as product_nutirent,
