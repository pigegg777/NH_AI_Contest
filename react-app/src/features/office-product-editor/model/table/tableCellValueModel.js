import { formatManufacturerList } from './tableQueryModel';

export const PRICE_COLUMN_KEYS = new Set(['tax_price', 'zero_tax_price', 'exempt_tax_price']);
export const NUMERIC_FORMAT_COLUMN_KEYS = new Set([...PRICE_COLUMN_KEYS, 'price_subsidy']);
