...
import { buildAiSimilarityExtractionRequestBody } from '../model/ai-similarity-extraction/aiSimilarityExtractionRequestBodyModel';
import { buildAiSimilarityExtractionPrompt } from '../model/ai-similarity-extraction/aiSimilarityExtractionPrompt';
import { extractStructuredPayload } from '../../../../functions/lib/openAiJsonRequest';

describe('AI similarity-extraction payload model', () => {
  it('builds the OpenAI request body with the separated prompt', () => {
    const fertilizerPrompt = buildAiSimilarityExtractionPrompt('fertilizer');
