...
import { createAiRecommendation } from '../model/ai-recommendations/aiRecommendationModel';
import { buildRuleBasedAiRecommendations } from '../model/ai-recommendations/ruleBasedRecommendationModel';
...
describe('workbook AI recommendations', () => {
  ...
  it('creates a local recommendation when zero tax price exceeds tax price', () => {
