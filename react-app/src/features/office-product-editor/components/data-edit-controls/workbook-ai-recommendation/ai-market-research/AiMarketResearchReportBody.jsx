import styles from './AiMarketResearchReportBody.module.css';

function formatKrw(amount) {
  return `${amount.toLocaleString('ko-KR')}원`;
}

export function AiMarketResearchReportBody({ marketResearch }) {
          ...
          {report.priceSources.map((source) => (
            <li key={source.url}>
              <a href={source.url} target="_blank" rel="noreferrer">
                {source.productName ? `${source.site} · ${source.productName}` : source.site}
              </a>
