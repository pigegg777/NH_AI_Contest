import styles from './WorkbookReviewTableNameCard.module.css';

export function WorkbookReviewTableNameCard({
  customTableName,
  inputRef,
  onTableNameChange,
  showsTableNameInput,
  ...
  return (
    <aside className={styles.tableNameCard} aria-label="테이블 이름 설정">
      ...
      {isCustomTableNameEmpty ? (
        <p className={styles.catalogInlineHint}>업로드에 사용할 테이블 이름을 입력하세요.</p>
      ) : validationError ? (
