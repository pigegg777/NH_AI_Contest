...
import { LinkCell, NoteCell, PriceCell, SelectionHeaderCheckbox, UsageCell } from './WorkbookReviewTableCells';
import {
...
import styles from './WorkbookReviewTable.module.css';
...
function SortButton({ column, sortState, onSortChange }) {
  ...
  const isDescending = isActive && sortState.direction === SORT_DIRECTION.descending;
...
export function WorkbookReviewTable({
  rows,
  columns,
  tableNameMode,
  sortState,
