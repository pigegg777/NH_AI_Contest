...
const INFORMATION_EMPHASIS_AI_ENDPOINT = '/api/storefront-ai/information-emphasis';
...
export async function postInformationEmphasisAiRequest(requestBody) {
  const {
    data: { session },
  ...
  const response = await fetch(INFORMATION_EMPHASIS_AI_ENDPOINT, {
    method: 'POST',
    headers: {
