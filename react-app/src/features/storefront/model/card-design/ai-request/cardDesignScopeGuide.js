export const CARD_DESIGN_SCOPE_GUIDES = [
  {
    ...
    rows: [
      ...
      { element: '카드 구조', example: '이미지를 왼쪽에 놓아줘' },
  ...
  },
  {
    ...
    rows: [
      ...
      { element: '크기', example: '이미지를 조금 더 크게 해줘' },
    ],
  ...
  },
  {
    ...
    title: '정보 영역',
    rows: [
      { element: '배경·테두리', example: '정보 영역에 연한 회색 배경을 넣어줘' },
      { element: '여백·모서리', example: '정보 영역 여백을 넉넉하게 해줘' },
