export const CARD_DESIGN_SCOPE_GUIDES = [
  {
    ...
    rows: [
      ...
      {
        element: '카드 구조',
        example: '제목은 위에 두고 이미지와 정보를 좌우로 나눠줘',
      },
      { element: '제목 위치', example: '제목을 카드 안쪽으로 넣어줘' },
    ],
    note: '카드자체의 디자인과 범용적인 디자인을 할 수 있습니다. 무엇을 선택할지 모른다면 전체에서 수정하세요',
  },
  {
    scopeId: 'header',
    title: '상품명(제목) 영역',
    ...
    note: '제목 문구 자체는 바꿀 수 없습니다. 데이터 텍스트 기반 디자인 수정도가능합니다.(ex 세분류가 퇴비인 배경색 노란색으로)',
  },
  {
    scopeId: 'image',
    title: '이미지 영역',
    rows: [
      {
        element: '채우기 방식',
        example: '이미지가 잘리지 않게 전체가 보이도록 해줘',
      },
  ...
  },
  {
    ...
    rows: [
      ...
      {
        element: '항목 묶음',
        example: '과세가격, 영세가격을 1줄에 나오도록 해줘',
      },
      { element: '라벨 색', example: '항목 이름을 더 연한 회색으로 해줘' },
      { element: '라벨 크기', example: '항목 이름을 한 단계 작게 해줘' },
      { element: '라벨 굵기', example: '항목 이름을 굵게 해줘' },
    ],
    note: '라벨은 항목 이름, 값은 실제 데이터입니다. 값 글씨는 옆의 상품정보 세부조정 칩에서 바꿉니다. 데이터 텍스트 기반 디자인 수정도가능합니다.(ex 세분류가 퇴비인 배경색 노란색으로)',
  },
  {
    scopeId: 'field',
    title: '상품정보 세부조정',
    rows: [
      {
        element: '전체 글자색',
        example: '항목 글씨를 모두 진한 회색으로 해줘',
      },
      {
        element: '전체 굵기',
        example: '항목 글씨를 전체적으로 조금 굵게 해줘',
      },
    ...
    note: '표시하기로 고른 항목만 바꿀 수 있습니다. 데이터 텍스트 기반 디자인 수정도가능합니다.(ex 세분류가 퇴비인 배경색 노란색으로)',
  },
];
