import { EMPTY_FILTER_VALUE, FILTER_FIELDS, SORT_DIRECTION } from './constants';
...
export function formatManufacturerList(manufacturerList) {
  ...
  return manufacturerList
    .map(({ manufacturer_code: manufacturerCode, manufacturer_name: manufacturerName }) =>
      [manufacturerName, manufacturerCode].filter(Boolean).join(' / '),
    )
    .join(', ');
}
